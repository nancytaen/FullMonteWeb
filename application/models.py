...
class opFileInput(models.Model):
    ...
    data_dir = models.CharField(max_length=255, blank=True, null=True)
    ...
    opt_file = models.CharField(max_length=255, blank=True, null=True)
    opt_file_storage = models.FileField(storage=PublicMediaStorage(),  blank=True, null=True)
    mesh_file_storage = models.FileField(storage=PublicMediaStorage(),  blank=True, null=True)
    tissue_property_file_storage = models.FileField(storage=PublicMediaStorage(),  blank=True, null=True)
    tissue_types_file_storage = models.FileField(storage=PublicMediaStorage(),  blank=True, null=True)
